                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td valign="top" style="line-height:150%;color:#5e5e5e;font-size:14px;font-family:Arial;text-align:left">
                                                                                                <div>
                                                                                                    Chào <?php echo $order['order_full_name']; ?>,
                                                                                                    <br>
                                                                                                    <div>Cảm ơn bạn đã đặt hàng của chúng tôi. Dưới đây là chi tiết đặt hàng của bạn:</div>
                                                                                                    <br>
                                                                                                    Ngày đặt: <?php echo date('d/m/Y', $order['created']); ?> lúc <?php echo date('h:i A', $order['created']); ?><br>
                                                                                                    ...
                                                                                                    Người nhận hàng: <strong><?php echo $order['order_full_name']; ?></strong><br>
                                                                                                    Địa chỉ giao hàng: <strong><?php echo $order['order_address']; ?></strong><br>
                                                                                                    Điện thoại: <strong><?php echo $order['order_phone']; ?></strong>
                                                                                                    <br>
                                                                                                    <br>
                                                                                                    <table cellspacing="0" cellpadding="0" width="100%">
                                                                                                        <tbody>
                                                                                                            ...
                                                                                                            <tr>
                                                                                                                <td style="font-family:Verdana,Tahoma,Sans-serif;font-size:12px;padding-right:40px" align="left" colspan="5">Tạm tính</td>
                                                                                                                <td style="font-family:Verdana,Tahoma,Sans-serif;font-size:12px;padding-left:10px;padding-right:10px;" align="right"><strong style="color: #f00; font-weight: 700;"><?php echo formatRice($order['order_amount']); ?></strong></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td colspan="6" bgcolor="#888888" height="1"></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td style="font-family:Verdana,Tahoma,Sans-serif;font-size:12px;padding-right:40px" align="left" colspan="5">Phí vận chuyển</td>
                                                                                                                <td style="font-family:Verdana,Tahoma,Sans-serif;font-size:12px;padding-left:10px;padding-right:10px;" align="right"><strong style="color: #f00; font-weight: 700;"><?php echo $order['order_shipping'] > 0 ? formatRice($order['order_shipping']) : 'Miễn phí'; ?></strong></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td colspan="6" bgcolor="#888888" height="1"></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                ...
                                                                                                                <td style="font-family:Verdana,Tahoma,Sans-serif;font-size:12px;border-bottom:solid 3px;padding-left:10px;padding-right:10px;" align="right"><strong style="color: #f00; font-weight: 700;"><?php echo formatRice($order['order_monetized']); ?></strong></td>
                                                                                                            </tr>
                                                                                                            <tr>
                                                                                                                <td colspan="6" bgcolor="#888888" height="1"></td>
                                                                                                            </tr>
