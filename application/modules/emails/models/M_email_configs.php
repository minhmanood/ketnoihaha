<?php
class M_email_configs extends CI_Model {

    public $_table_name = 'email_configs';
...
/* End of file M_email_configs.php */
/* Location: ./application/modules/emails/models/M_email_configs.php */