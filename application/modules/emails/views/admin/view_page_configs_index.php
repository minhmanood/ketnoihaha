    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><em class="fa fa-table">&nbsp;</em>Danh sách cấu hình email</h3>
            ...
            <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
											...
											<td class="text-center">
                                                <input class="text-right form-control" name="order[]" type="text" value="<?php echo $row['order']; ?>" style="width: 80px;">
                                                <input class="text-right form-control" name="ids[]" type="hidden" value="<?php echo $row['id']; ?>">
                                            </td>
                                            <td><?php echo $row['smtp_user']; ?></td>
                                            <td><?php echo $row['protocol']; ?></td>
                                            <td><?php echo $row['smtp_host']; ?></td>
											<td><?php echo $row['smtp_port']; ?></td>
                                            <td class="text-center">
                                                <input type="checkbox" name="active[]" class="change-active flat-blue" value="<?php echo $row['id']; ?>"<?php echo ($row['active'] == 1) ? ' checked="checked"' : ''; ?> />
                                            </td>
                ...
                <?php else: ?>
                    <div class="callout callout-warning">
                        <h4>Thông báo!</h4>
                        <p><b>Không</b> có cấu hình email nào!</p>
                    </div>
                <?php endif; ?>
            </div>
