        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="f-cat" role="form" action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" autocomplete="off">
					...
					<div class="form-group">
						<label for="display" class="control-label">Hiển thị (menu gốc có menu con)</label>
						<select class="form-control" name="display" id="display">
							<?php echo get_option_select($this->config->item('menu_modules_display'), isset($row['display']) ? $row['display'] : ''); ?>
						</select>
					</div>
