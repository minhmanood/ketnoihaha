    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><em class="fa fa-table">&nbsp;</em>Danh sách sự kiện</h3>
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img width="40" class="img-rounded img-responsive" alt="<?php echo $row['name']; ?>" src="<?php echo get_image(get_module_path('projects') . $row['image'], get_module_path('projects') . 'no-image.png'); ?>">
                                            </td>
