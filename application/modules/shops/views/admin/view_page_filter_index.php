    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box box-primary">
            <div class="box-header with-border">
                <h3 class="box-title"><em class="fa fa-table">&nbsp;</em>Danh sách thương hiệu</h3>
            ...
            <div class="box-body">
                                ...
                                <tbody>
                                    <?php foreach ($rows as $row): ?>
                                        <tr>
											...
											<td class="text-center">
                                                <img class="img-responsive img-thumbnail" src="<?php echo get_image(get_module_path('shops_filter') . $row['image'], get_module_path('shops_filter') . 'no-image.png'); ?>" width="80px;" alt="" >
                                            </td>
                ...
                <?php else: ?>
                    <div class="callout callout-warning">
                        <h4>Thông báo!</h4>
                        <p><b>Không</b> có thương hiệu nào!</p>
                    </div>
                <?php endif;?>
            </div>
