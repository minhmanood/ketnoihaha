...
class Configs extends Layout {
    ...
    function index() {
        ...
        if (!empty($post)) {
            $data = array(
				...
				// 'cod' => serialize($this->input->post('cod')),
				// 'bacs' => serialize($this->input->post('bacs')),
				// 'cheque' => serialize($this->input->post('cheque')),
    ...
    function main() {
        ...
        if (!empty($post)) {
            ...
            $input_name_site_logo_footer = 'site_logo_footer';
            $this->_upload_image_systems($input_name_site_logo_footer, $this->_logo);
