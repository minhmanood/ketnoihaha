        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                <form id="f-cat" role="form" action="<?php echo get_admin_url('settings/main'); ?>" method="post" autocomplete="off"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <?php $site_logo_footer = (isset($configs['site_logo_footer']) && ($configs['site_logo_footer'] != '') ? $configs['site_logo_footer'] : 'logo_default.png'); ?>
                        <label for="site_logo_footer" class="control-label">Ảnh breadcrumb (Nên chọn PNG)</label>
                        <input id="site_logo_footer" name="site_logo_footer[]" class="file" type="file">
                        <div id="current-site_logo_footer" style="margin-top: 10px;">
                            <img src="<?php echo base_url(get_module_path('logo') . $site_logo_footer); ?>" width="100px" alt="" class="img-thumbnail">
                        </div>
                    </div>
